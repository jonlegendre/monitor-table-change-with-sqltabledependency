...
namespace TableDependency.SqlClient.Test
{
    ...
    [TestClass]
    public class UpdateOfUsingLambaTest : Base.SqlTableDependencyBaseTest
    {
        private static readonly string TableName = typeof(UpdateOfUsingLambaTestSqlServerModel).Name.ToUpper();
        private static int _counter;
        private static Dictionary<string, Tuple<UpdateOfUsingLambaTestSqlServerModel, UpdateOfUsingLambaTestSqlServerModel>> _checkValues = new Dictionary<string, Tuple<UpdateOfUsingLambaTestSqlServerModel, UpdateOfUsingLambaTestSqlServerModel>>();
        private static Dictionary<string, Tuple<UpdateOfUsingLambaTestSqlServerModel, UpdateOfUsingLambaTestSqlServerModel>> _checkValuesOld = new Dictionary<string, Tuple<UpdateOfUsingLambaTestSqlServerModel, UpdateOfUsingLambaTestSqlServerModel>>();
        ...
        public void TestInitialize()
        {
            ...
            _checkValues.Add(ChangeType.Insert.ToString(), new Tuple<UpdateOfUsingLambaTestSqlServerModel, UpdateOfUsingLambaTestSqlServerModel>(new UpdateOfUsingLambaTestSqlServerModel { Name = "Christian", Surname = "Del Bianco" }, new UpdateOfUsingLambaTestSqlServerModel()));
            _checkValues.Add(ChangeType.Update.ToString(), new Tuple<UpdateOfUsingLambaTestSqlServerModel, UpdateOfUsingLambaTestSqlServerModel>(new UpdateOfUsingLambaTestSqlServerModel { Name = "Velia", Surname = "Del Bianco" }, new UpdateOfUsingLambaTestSqlServerModel()));
            _checkValues.Add(ChangeType.Delete.ToString(), new Tuple<UpdateOfUsingLambaTestSqlServerModel, UpdateOfUsingLambaTestSqlServerModel>(new UpdateOfUsingLambaTestSqlServerModel { Name = "Velia", Surname = "Del Bianco" }, new UpdateOfUsingLambaTestSqlServerModel()));

            _checkValuesOld.Add(ChangeType.Insert.ToString(), new Tuple<UpdateOfUsingLambaTestSqlServerModel, UpdateOfUsingLambaTestSqlServerModel>(new UpdateOfUsingLambaTestSqlServerModel { Name = "Christian", Surname = "Del Bianco" }, new UpdateOfUsingLambaTestSqlServerModel()));
            _checkValuesOld.Add(ChangeType.Update.ToString(), new Tuple<UpdateOfUsingLambaTestSqlServerModel, UpdateOfUsingLambaTestSqlServerModel>(new UpdateOfUsingLambaTestSqlServerModel { Name = "Velia", Surname = "Del Bianco" }, new UpdateOfUsingLambaTestSqlServerModel()));
            _checkValuesOld.Add(ChangeType.Delete.ToString(), new Tuple<UpdateOfUsingLambaTestSqlServerModel, UpdateOfUsingLambaTestSqlServerModel>(new UpdateOfUsingLambaTestSqlServerModel { Name = "Velia", Surname = "Del Bianco" }, new UpdateOfUsingLambaTestSqlServerModel()));
        }
        ...
        private static void ModifyTableContent()
        {
            using (var sqlConnection = new SqlConnection(ConnectionStringForTestUser))
            {
                ...
                using (var sqlCommand = sqlConnection.CreateCommand())
                {
                    sqlCommand.CommandText = $"UPDATE [{TableName}] SET [Surname] = '{_checkValues[ChangeType.Update.ToString()].Item1.Surname}'";
                    sqlCommand.ExecuteNonQuery();
                }
