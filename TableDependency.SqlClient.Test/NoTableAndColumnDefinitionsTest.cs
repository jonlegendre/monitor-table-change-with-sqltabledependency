...
{
    [TestClass]
    public class NoTableAndColumnDefinitionsTestSqlServerTest : Base.SqlTableDependencyBaseTest
    {
        private class NoTableAndColumnDefinitionsTestSqlServerTestModel
        {
